(() => {
  ...
  const POSITIONS = [
    ...
    { id:'ruck', role:'RUCK', label:'Ruck', x:41, y:56 },
    { id:'centre', role:'C', label:'Centre', x:59, y:56 },
    { id:'wing_right', role:'W', label:'Wing', x:83, y:50 },
    { id:'ruck_rover', role:'RR', label:'Ruck Rover', x:41, y:68 },
    { id:'rover', role:'ROV', label:'Rover', x:59, y:68 },
    { id:'hbf_left', role:'HBF', label:'Half Back Flank', x:26, y:76 },
    { id:'chb', role:'CHB', label:'Centre Half Back', x:50, y:75 },
