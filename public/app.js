(() => {
  ...
  const POSITIONS = [
    ...
    { id:'centre', role:'C', label:'Centre', x:50, y:50 },
    { id:'wing_right', role:'W', label:'Wing', x:78, y:50 },
    { id:'ruck', role:'RUCK', label:'Ruck', x:50, y:43 },
    { id:'ruck_rover', role:'RR', label:'Ruck Rover', x:50, y:57 },
    { id:'rover', role:'ROV', label:'Rover', x:50, y:64 },
