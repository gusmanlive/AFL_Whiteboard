(() => {
  ...
  const POSITIONS = [
    ...
    { id:'hff_left', role:'HFF', label:'Half Forward Flank', x:26, y:28 },
    { id:'chf', role:'CHF', label:'Centre Half Forward', x:50, y:27 },
    { id:'hff_right', role:'HFF', label:'Half Forward Flank', x:74, y:28 },
    { id:'wing_left', role:'W', label:'Wing', x:17, y:50 },
    { id:'centre', role:'C', label:'Centre', x:57, y:60 },
    { id:'wing_right', role:'W', label:'Wing', x:83, y:50 },
    { id:'ruck', role:'RUCK', label:'Ruck', x:43, y:60 },
    { id:'ruck_rover', role:'RR', label:'Ruck Rover', x:43, y:72 },
    { id:'rover', role:'ROV', label:'Rover', x:57, y:72 },
    { id:'hbf_left', role:'HBF', label:'Half Back Flank', x:26, y:82 },
    { id:'chb', role:'CHB', label:'Centre Half Back', x:50, y:83 },
    { id:'hbf_right', role:'HBF', label:'Half Back Flank', x:74, y:82 },
    { id:'bp_left', role:'BP', label:'Back Pocket', x:30, y:88 },
    { id:'fb', role:'FB', label:'Full Back', x:50, y:89 },
    { id:'bp_right', role:'BP', label:'Back Pocket', x:70, y:88 }
  ];
