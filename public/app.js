(() => {
  ...
  const POSITIONS = [
    ...
    { id:'ruck', role:'RUCK', label:'Ruck', x:41, y:53 },
    { id:'centre', role:'C', label:'Centre', x:59, y:53 },
    { id:'wing_right', role:'W', label:'Wing', x:83, y:50 },
    { id:'ruck_rover', role:'RR', label:'Ruck Rover', x:41, y:61 },
    { id:'rover', role:'ROV', label:'Rover', x:59, y:61 },
